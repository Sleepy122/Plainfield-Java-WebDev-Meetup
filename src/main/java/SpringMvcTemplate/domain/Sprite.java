...
public class Sprite {
	...
	public Sprite(String back_shiny_female, String back_female, String back_default, String front_shiny_female,
			String front_default, String front_female, String back_shiny, String front_shiny) {
		super();
